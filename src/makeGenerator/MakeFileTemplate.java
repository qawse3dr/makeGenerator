...
public class MakeFileTemplate{
  ...
  //config file holding added functions vars, and platform definitions
  private MakeConfig config = null;
    ...
    for (Map.Entry<String, String> entry : parser.getFlags().entrySet()) {
      switch(entry.getKey()){
        ...
        case "i":
          ...
          break;
        case "config":
          config = new MakeConfig(entry.getValue());
  ...
  */
  ...
  public void write(){
    try{
      ...
      //Comments
      printWriter.printf("#-----------------------------------------------\n");
      printWriter.printf("#This makefile is autogenerated by makeGenerator\n");
      printWriter.printf("#Created by and maintained by qawse3dr\n");
      printWriter.printf("#-----------------------------------------------\n\n");
      //global vars
      ...
      printWriter.printf("\n%s\n",config.getCustomIfs());
      //main executable
      printWriter.printf("all:init $(buildDIR)%s\n\n",executableName);
      ...
      printWriter.printf("$(buildDIR)%s:$(objects)\n",executableName);
